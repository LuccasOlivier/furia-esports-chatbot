"""
Django settings for furia_chatbot project.
...
# Adicionando o caminho correto para a pasta 'chatbot/static'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'chatbot/static'),  # Diretório de arquivos estáticos
]
